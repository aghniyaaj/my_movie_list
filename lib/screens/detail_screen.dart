...
class DetailScreen extends StatefulWidget {
  ...
  const DetailScreen({required this.movie, this.scrollToReviews = false});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(child: _buildActionButton('Watched', Icons.add, 'watched', _isWatched)),
            ...
            const SizedBox(height: 8),
            Text(widget.movie.overview, style: const TextStyle(color: AppColors.textGrey, height: 1.5)),
            const SizedBox(height: 24),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          CircleAvatar(backgroundColor: AppColors.primaryRed, child: Text(review['userName'][0], style: const TextStyle(color: Colors.white))),
